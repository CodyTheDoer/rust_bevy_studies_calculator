...
//     // let valid_kz = direction[kz].abs() > f32_epsilon_check; //Ensure we're not dividing against zero
//     // if !valid_kz { // Early return if direction[kz] is too close to zero
//     //     return None;
//     // }
...
//     // Fallback to test against edges using double precision
//     if (u.abs() < f32_epsilon_check || v.abs() < f32_epsilon_check || u.abs() < f32_epsilon_check) {
//         let cx_by: f64 = f64::from(point_c_x) * f64::from(point_b_y);
//         let cy_bx: f64 = f64::from(point_c_y) * f64::from(point_b_x);
//         u = (cx_by - cy_bx) as f32;
...
//     let hit = Hit {
//         u: u * reciprocal_of_determinate,
//         v: v * reciprocal_of_determinate,
//         w: w * reciprocal_of_determinate,
//         t: t * reciprocal_of_determinate,
//     }
...
//     Some(hit) => {
//         // Handle intersection
//         println!("Intersection at t = {}", hit.t);
//     },
//     None => {
